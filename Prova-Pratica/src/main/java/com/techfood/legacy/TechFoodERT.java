package com.techfood.legacy;

import java.util.Scanner;

public class TechFoodERT {
    //VETORES SIMULANDOBANCO DE DADOS(Atributos Estáticos)
                    ...
                    if (subOp == 1) {
                        ...
                        case 3: // CARDÁPIO (Viola SRP)
                            for (int i = 0; i < pratoTotal; i++)
                                System.out.println(i + ": " + pratoNomes[i] + " - R$ " + pratoPrecos[i]);
